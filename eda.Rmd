...
> Perhaps we should explore using previous week's precipitation data for prediction as it seesms to have a higher p value. Or in some other way reference recent precipitation history instead of same day history
