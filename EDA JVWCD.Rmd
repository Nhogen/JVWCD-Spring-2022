...
Difference in weather and water granularity? Is hourly weather data available? Or are we going to change our forecast granularity to daily to match with the weather?
...
At this point, does it make sense to move forward by moving this cleaned and merged data into a Tableau dashboard/forecast?
